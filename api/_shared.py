"""Shared pure functions for the standalone API layer.

Provides verdict determination logic and role utilities needed by
api/runner.py and api/discovery.py. This module mirrors the subset of
the root _shared.py that the API layer depends on.

Zero external dependencies — these are standalone pure functions.
"""
import re
