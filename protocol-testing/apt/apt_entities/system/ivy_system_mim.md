...
```
var sock_mim_server : system_net.socket
var sock_mim_client : system_net.socket

instance mim_agent : endpoint.man_in_the_middle_endpoint.mim_system_ep(server_addr,mim_port_in,server_port,true,true,true)
