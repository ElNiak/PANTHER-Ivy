...
parameter n_clients : stream_pos = 0x2
...
after init {
    client := clients.clients.value(0);
    server := servers.servers.value(0);
}
...
```
instance sockets : array(idx,quic_net.socket)
