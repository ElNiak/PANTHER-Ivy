...
```
    ...
    if(is_lost_recv_example_ext_ack_freq) {
...
if ~endpoint_to_pid(src) = endpoint_id.man_in_the_middle {
```
...
```
instance malicious_protected_pkt_serdes : serdes(packet.malicious_protected_quic_packet,stream_data,quic_ser_forged,quic_deser_forged)
instance malicious_pkt_serdes : serdes(packet.malicious_quic_packet,stream_data,quic_ser,quic_deser)
instance malicious_pkt_serdes_vn : serdes(packet.malicious_quic_packet_vn,stream_data,quic_ser_vn,quic_deser_vn)
instance malicious_pkt_serdes_retry : serdes(packet.malicious_quic_packet_retry,stream_data,quic_ser_retry,quic_deser_retry)
instance replayed_pkt_serdes_0rtt : serdes(packet.replayed_quic_packet_0rtt,stream_data,quic_ser_zerortt,quic_deser_zerortt)
