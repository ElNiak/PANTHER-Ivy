...
The type `packet.quic_packet_vn` represents packet.
...
```
action packet_event_vn(src:ip.endpoint,dst:ip.endpoint,pkt:packet.quic_packet_vn) = {}
...
```
around packet_event_vn(src:ip.endpoint,dst:ip.endpoint,pkt:packet.quic_packet_vn) {
```
