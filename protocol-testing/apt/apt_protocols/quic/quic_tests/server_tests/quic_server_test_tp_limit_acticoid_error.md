...
```
  A NEW_CONNECTION_ID quic_frameframeframe might cause an endpoint to add some active
   connection IDs and retire others based on the value of the Retire
   Prior To field.  After processing a NEW_CONNECTION_ID quic_frameframeframe and
...
attribute quic_frameframeframe.new_connection_id.handle.weight = "5"
