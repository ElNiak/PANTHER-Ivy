...
```
object replayed_quic_packet_0rtt = {
    type this = struct {
```
0rtt packet
```
...
```
action replayed_packet_event_0rtt(src:ip.endpoint,dst:ip.endpoint,pkt:replayed_quic_packet_0rtt) = {}
...
around replayed_packet_event_0rtt(src:ip.endpoint,dst:ip.endpoint,pkt:replayed_quic_packet_0rtt) {
```
