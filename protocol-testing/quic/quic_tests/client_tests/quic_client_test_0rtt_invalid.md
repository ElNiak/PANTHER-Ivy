...
```
test to set value less than before [7-0rtt]
```
after init {
    initial_max_stream_data_uni_server_0rtt := 4000;
    initial_max_stream_data_bidi_remote_server_0rtt := 4000;
    initial_max_data_server_0rtt := 4000;
    initial_max_stream_data_bidi_local_server_0rtt := 4000;
    initial_max_stream_id_bidi_server_0rtt := 100;
    active_connection_id_limit_server_0rtt := 100;
}
...
chris TODO
```
    require is_no_error | ~tls_handshake_finished;
