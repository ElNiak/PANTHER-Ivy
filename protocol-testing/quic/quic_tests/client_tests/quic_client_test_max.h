...
void __init();
    ...
    virtual quic_client_test_max::tls_api__id ext__prot__cid_to_tls_id(quic_client_test_max::cid c);
    ...
    virtual void show_connected(bool c1, quic_client_test_max::cid c2);
    ...
    virtual void imp__show_connected(bool c1, quic_client_test_max::cid c2);
