...
public:
    ...
    #ifdef Z3PP_H_
    static z3::sort z3_sort(z3::context &ctx) {return ctx.bv_sort(10);}
...
return hv;
    ...
    enum ip__interface{ip__lo,ip__ivy};
    struct ip__endpoint {
...
class hash____tup__unsigned__unsigned__unsigned__cid__unsigned {
    public:
        size_t operator()(const quic_client_test_max::__tup__unsigned__unsigned__unsigned__cid__unsigned &__s) const {
...
class hash____tup__cid__stream_data {
    ...
    forged_pkts mim_agent__ppkt_to_be_reflected_to_victim;
    ...
    stream_data mim_agent__ppkt_saved;
    ...
    hash_thunk<unsigned long long,forged_pkts> mim_agent__ppkt_to_be_forwarded_to_server;
    hash_thunk<cid,bool> max_data_set;
    hash_thunk<__tup__cid__unsigned,bool> stream_finished;
    unsigned mim_addr;
    forged_pkts mim_agent__ppkt_to_be_replayed_to_server;
    ...
    quic_packet_type mim_agent__enc_level_ppkt_to_be_forge;
    int start_delay;
    ...
    hash_thunk<unsigned long long,forged_pkts> mim_agent__ppkt_to_be_forwarded_to_client;
    int sock_mim_client;
    ...
    virtual quic_client_test_max::frame frame__arr__value(const frame__arr& a, unsigned long long i);
...
void __init();
    ...
    virtual void enqueue_frame_rtt(quic_client_test_max::cid scid, quic_client_test_max::frame f, quic_packet_type e, bool probing);
    ...
    virtual void ext__recv_packet_victim(endpoint_id host, const ip__endpoint& src, const ip__endpoint& dst, const stream_data& pkt);
    ...
    virtual void imp__recv_packet_victim(endpoint_id host, const ip__endpoint& src, const ip__endpoint& dst, const stream_data& pkt);
    ...
    virtual void ext__frame__ack__handle(frame__ack f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__frame__path_response__handle(frame__path_response f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__frame__max_stream_data__handle(frame__max_stream_data f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__frame__handle(quic_client_test_max::frame f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__frame__rst_stream__handle(const frame__rst_stream& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__frame__ping__handle(const frame__ping& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__frame__unknown_frame__handle(const frame__unknown_frame& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__attacker__behavior(endpoint_id host, int s, const ip__endpoint& src, const prot__arr& pkts);
    ...
    virtual quic_client_test_max::cid ext__double_cid(quic_client_test_max::cid c);
    ...
    virtual void ext__frame__application_close__handle(const frame__application_close& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    virtual void imp__show_time_of_last_ack_eliciting_packet(int time_of_last_ack_eliciting_packet, quic_packet_type ptype);
    virtual void ext__mim_agent__forward_packet_to(const stream_data& ppkt, endpoint_id host, int s, const ip__endpoint& src, const ip__endpoint& dst);
    virtual void ext__app_send_event(const ip__endpoint& src, const ip__endpoint& dst, quic_client_test_max::cid dcid, unsigned s, const stream_data& data, unsigned long long pos, bool close);
    virtual quic_client_test_max::cid prot__bytes_to_cid(const stream_data& bytes);
    ...
    virtual void ext__frame__ack_frequency__handle(const frame__ack_frequency& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    virtual void ext__detect_and_remove_lost_packets(quic_packet_type pn_space, quic_client_test_max::cid dcid);
    virtual void ext__frame__max_streams_bidi__handle(const frame__max_streams_bidi& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__frame__data_blocked__handle(const frame__data_blocked& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual quic_client_test_max::cid ext__prot__bytes_to_cid(const stream_data& bytes);
    virtual void ext__frame__retire_connection_id__handle(const frame__retire_connection_id& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    virtual prot__arr prot__arr__empty();
    virtual void ext__frame__max_data__handle(frame__max_data f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__frame__stop_sending__handle(const frame__stop_sending& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual stream_data prot__retry_integrity_tag(unsigned long long odcil, quic_client_test_max::cid odcid, unsigned pversion, unsigned long long dcil, quic_client_test_max::cid dcid, unsigned long long scil, quic_client_test_max::cid scid, const stream_data& token, unsigned seq, unsigned long long h, bool b);
    ...
    virtual void prot__encrypt(quic_client_test_max::tls_api__id c, unsigned seq, stream_data& pkt);
    ...
    virtual void ext__victim_agent__behavior(endpoint_id host, int s, const ip__endpoint& src, const prot__arr& pkts);
    ...
    virtual void ext__frame__new_connection_id__handle(const frame__new_connection_id& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual tls_api__upper__decrypt_result ext__prot__decrypt(quic_client_test_max::tls_api__id c, unsigned seq, const stream_data& pkt);
    ...
    virtual quic_client_test_max::tls_api__id ext__cid_to_us(quic_client_test_max::cid c);
    ...
    virtual void imp__show_queued_frames(quic_client_test_max::cid scid, const frame__arr& queued_frames);
    ...
    virtual void ext__frame__handshake_done__handle(frame__handshake_done f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__frame__immediate_ack__handle(const frame__immediate_ack& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void imp__show_biatch(const ip__endpoint& src);
    ...
    virtual void ext__frame__path_challenge__handle(const frame__path_challenge& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__mim_agent__reflection_packets(const stream_data& ppkt, unsigned dst_port);
    virtual void ext__frame__malicious_frame__handle(const frame__malicious_frame& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__frame__streams_blocked__handle(const frame__streams_blocked& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__show_biatch(const ip__endpoint& src);
    ...
    virtual void ext__forged_pkts__append(forged_pkts& a, const stream_data& v);
    virtual bool acti_coid_check(quic_client_test_max::cid scid, unsigned long long count);
    virtual void ext__frame__connection_close__handle(const frame__connection_close& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void app_send_event(const ip__endpoint& src, const ip__endpoint& dst, quic_client_test_max::cid dcid, unsigned s, const stream_data& data, unsigned long long pos, bool close);
    ...
    virtual void ext__infer_frame(quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_client_test_max::frame f);
    ...
    virtual void imp__infer_frame(quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_client_test_max::frame f);
    ...
    virtual void ext__frame__ack_ecn__handle(const frame__ack_ecn& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__mim_agent__save_packets(const stream_data& ppkt);
    virtual void ext__mim_server_target__set_ep(const ip__endpoint& e);
    virtual void ext__fake_client__set_ep(const ip__endpoint& e);
    ...
    virtual void imp__show_socket(int n);
    virtual void ext__mim_client_target__set_ep(const ip__endpoint& e);
    ...
    virtual void ext__frame__stream_data_blocked__handle(const frame__stream_data_blocked& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__frame__crypto__handle(frame__crypto f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    virtual int ext__net__impl__listen(endpoint_id prm__V0, const ip__endpoint& dst);
    ...
    virtual void ext__mim_agent__behavior(endpoint_id host, int s, const ip__endpoint& src, const prot__arr& pkts);
    ...
    virtual void ext__frame__stream__handle(frame__stream f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__export_length_cid_mim(unsigned long long dcil, unsigned long long scil);
    ...
    virtual void ext__frame__max_streams__handle(frame__max_streams f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void ext__recv_packet_mim(endpoint_id host, const ip__endpoint& src, const ip__endpoint& dst, const stream_data& pkt);
    ...
    virtual void ext__frame__streams_blocked_bidi__handle(const frame__streams_blocked_bidi& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    ...
    virtual void show_queued_frames(quic_client_test_max::cid scid, const frame__arr& queued_frames);
    virtual void on_ack_received(const ip__endpoint& dst, unsigned largest_acked, int ack_delay, quic_packet_type pn_space);
    virtual void ext__frame__arr__append(frame__arr& a, quic_client_test_max::frame v);
    ...
    virtual void ext__show_socket(int n);
    ...
    virtual void enqueue_frame(quic_client_test_max::cid scid, quic_client_test_max::frame f, quic_packet_type e, bool probing, unsigned seq);
    ...
    virtual quic_client_test_max::cid ext__packet_scid(const prot__header_info& h);
    virtual void imp__recv_packet_mim(endpoint_id host, const ip__endpoint& src, const ip__endpoint& dst, const stream_data& pkt);
    ...
    virtual void ext__frame__new_token__handle(const frame__new_token& f, quic_client_test_max::cid scid, quic_client_test_max::cid dcid, quic_packet_type e, unsigned seq_num);
    virtual int ext__net__listen(endpoint_id me, const ip__endpoint& addr);
...
inline bool operator ==(const quic_client_test_max::frame &s, const quic_client_test_max::frame &t);;
...
inline bool operator ==(const quic_client_test_max::frame__ping &s, const quic_client_test_max::frame__ping &t){
    return true;
}
inline bool operator ==(const quic_client_test_max::frame__ack__range &s, const quic_client_test_max::frame__ack__range &t){
    return ((s.gap == t.gap) && (s.ranges == t.ranges));
}
inline bool operator ==(const quic_client_test_max::frame__ack &s, const quic_client_test_max::frame__ack &t){
    return ((s.largest_acked == t.largest_acked) && (s.ack_delay == t.ack_delay) && (s.ack_ranges == t.ack_ranges));
}
inline bool operator ==(const quic_client_test_max::frame__ack_ecn__range &s, const quic_client_test_max::frame__ack_ecn__range &t){
    return ((s.gap == t.gap) && (s.ranges == t.ranges));
}
inline bool operator ==(const quic_client_test_max::frame__ack_ecn &s, const quic_client_test_max::frame__ack_ecn &t){
...
inline bool operator ==(const quic_client_test_max::frame__rst_stream &s, const quic_client_test_max::frame__rst_stream &t){
    return ((s.id == t.id) && (s.err_code == t.err_code) && (s.final_offset == t.final_offset));
}
inline bool operator ==(const quic_client_test_max::frame__stop_sending &s, const quic_client_test_max::frame__stop_sending &t){
    return ((s.id == t.id) && (s.err_code == t.err_code));
}
inline bool operator ==(const quic_client_test_max::frame__crypto &s, const quic_client_test_max::frame__crypto &t){
    return ((s.offset == t.offset) && (s.length == t.length) && (s.data == t.data));
}
inline bool operator ==(const quic_client_test_max::frame__new_token &s, const quic_client_test_max::frame__new_token &t){
    return ((s.length == t.length) && (s.data == t.data));
}
inline bool operator ==(const quic_client_test_max::frame__stream &s, const quic_client_test_max::frame__stream &t){
    return ((s.off == t.off) && (s.len == t.len) && (s.fin == t.fin) && (s.id == t.id) && (s.offset == t.offset) && (s.length == t.length) && (s.data == t.data));
}
inline bool operator ==(const quic_client_test_max::frame__max_data &s, const quic_client_test_max::frame__max_data &t){
    return ((s.pos == t.pos));
}
inline bool operator ==(const quic_client_test_max::frame__max_stream_data &s, const quic_client_test_max::frame__max_stream_data &t){
    return ((s.id == t.id) && (s.pos == t.pos));
}
inline bool operator ==(const quic_client_test_max::frame__max_streams &s, const quic_client_test_max::frame__max_streams &t){
    return ((s.id == t.id));
}
inline bool operator ==(const quic_client_test_max::frame__max_streams_bidi &s, const quic_client_test_max::frame__max_streams_bidi &t){
    return ((s.id == t.id));
}
inline bool operator ==(const quic_client_test_max::frame__data_blocked &s, const quic_client_test_max::frame__data_blocked &t){
    return ((s.pos == t.pos));
}
inline bool operator ==(const quic_client_test_max::frame__stream_data_blocked &s, const quic_client_test_max::frame__stream_data_blocked &t){
    return ((s.id == t.id) && (s.pos == t.pos));
}
inline bool operator ==(const quic_client_test_max::frame__streams_blocked &s, const quic_client_test_max::frame__streams_blocked &t){
    return ((s.id == t.id));
}
inline bool operator ==(const quic_client_test_max::frame__streams_blocked_bidi &s, const quic_client_test_max::frame__streams_blocked_bidi &t){
    return ((s.id == t.id));
}
inline bool operator ==(const quic_client_test_max::frame__new_connection_id &s, const quic_client_test_max::frame__new_connection_id &t){
    return ((s.seq_num == t.seq_num) && (s.retire_prior_to == t.retire_prior_to) && (s.length == t.length) && (s.scid == t.scid) && (s.token == t.token));
}
inline bool operator ==(const quic_client_test_max::frame__retire_connection_id &s, const quic_client_test_max::frame__retire_connection_id &t){
    return ((s.seq_num == t.seq_num));
}
inline bool operator ==(const quic_client_test_max::frame__path_challenge &s, const quic_client_test_max::frame__path_challenge &t){
    return ((s.data == t.data));
}
inline bool operator ==(const quic_client_test_max::frame__path_response &s, const quic_client_test_max::frame__path_response &t){
    return ((s.data == t.data));
}
inline bool operator ==(const quic_client_test_max::frame__connection_close &s, const quic_client_test_max::frame__connection_close &t){
...
inline bool operator ==(const quic_client_test_max::frame__application_close &s, const quic_client_test_max::frame__application_close &t){
    return ((s.err_code == t.err_code) && (s.reason_phrase_length == t.reason_phrase_length) && (s.reason_phrase == t.reason_phrase));
}
inline bool operator ==(const quic_client_test_max::frame__handshake_done &s, const quic_client_test_max::frame__handshake_done &t){
    return true;
}
inline bool operator ==(const quic_client_test_max::frame__ack_frequency &s, const quic_client_test_max::frame__ack_frequency &t){
...
inline bool operator ==(const quic_client_test_max::frame__immediate_ack &s, const quic_client_test_max::frame__immediate_ack &t){
    return true;
}
inline bool operator ==(const quic_client_test_max::frame__unknown_frame &s, const quic_client_test_max::frame__unknown_frame &t){
    return true;
}
inline bool operator ==(const quic_client_test_max::frame__malicious_frame &s, const quic_client_test_max::frame__malicious_frame &t){
    return ((s.data == t.data));
}

bool operator ==(const quic_client_test_max::frame &s, const quic_client_test_max::frame &t){
    if (s.tag != t.tag) return false;
    switch (s.tag) {
        case 0: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__ping >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__ping >(t);
        case 1: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__ack >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__ack >(t);
        case 2: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__ack_ecn >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__ack_ecn >(t);
        case 3: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__rst_stream >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__rst_stream >(t);
        case 4: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__stop_sending >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__stop_sending >(t);
        case 5: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__crypto >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__crypto >(t);
        case 6: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__new_token >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__new_token >(t);
        case 7: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__stream >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__stream >(t);
        case 8: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__max_data >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__max_data >(t);
        case 9: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__max_stream_data >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__max_stream_data >(t);
        case 10: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__max_streams >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__max_streams >(t);
        case 11: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__max_streams_bidi >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__max_streams_bidi >(t);
        case 12: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__data_blocked >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__data_blocked >(t);
        case 13: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__stream_data_blocked >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__stream_data_blocked >(t);
        case 14: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__streams_blocked >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__streams_blocked >(t);
        case 15: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__streams_blocked_bidi >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__streams_blocked_bidi >(t);
        case 16: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__new_connection_id >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__new_connection_id >(t);
        case 17: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__retire_connection_id >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__retire_connection_id >(t);
        case 18: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__path_challenge >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__path_challenge >(t);
        case 19: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__path_response >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__path_response >(t);
        case 20: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__connection_close >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__connection_close >(t);
        case 21: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__application_close >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__application_close >(t);
        case 22: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__handshake_done >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__handshake_done >(t);
        case 23: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__ack_frequency >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__ack_frequency >(t);
        case 24: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__immediate_ack >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__immediate_ack >(t);
        case 25: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__unknown_frame >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__unknown_frame >(t);
        case 26: return quic_client_test_max::frame::unwrap< quic_client_test_max::frame__malicious_frame >(s) == quic_client_test_max::frame::unwrap< quic_client_test_max::frame__malicious_frame >(t);

    }
    return true;
}
inline bool operator ==(const quic_client_test_max::quic_packet_vn &s, const quic_client_test_max::quic_packet_vn &t){
...
inline bool operator ==(const quic_client_test_max::quic_packet &s, const quic_client_test_max::quic_packet &t){
...
inline bool operator ==(const quic_client_test_max::quic_packet_retry &s, const quic_client_test_max::quic_packet_retry &t){
...
inline bool operator ==(const quic_client_test_max::quic_packet_0rtt &s, const quic_client_test_max::quic_packet_0rtt &t){
...
inline bool operator ==(const quic_client_test_max::quic_packet_coal_0rtt &s, const quic_client_test_max::quic_packet_coal_0rtt &t){
...
inline bool operator ==(const quic_client_test_max::forged_protected_quic_packet &s, const quic_client_test_max::forged_protected_quic_packet &t){
...
inline bool operator ==(const quic_client_test_max::forged_quic_packet &s, const quic_client_test_max::forged_quic_packet &t){
    return ((s.ptype == t.ptype) && (s.pversion == t.pversion) && (s.dst_cid == t.dst_cid) && (s.src_cid == t.src_cid) && (s.token == t.token) && (s.seq_num == t.seq_num) && (s.payload == t.payload));
}
inline bool operator ==(const quic_client_test_max::forged_quic_packet_retry &s, const quic_client_test_max::forged_quic_packet_retry &t){
    return ((s.ptype == t.ptype) && (s.pversion == t.pversion) && (s.dst_cid == t.dst_cid) && (s.src_cid == t.src_cid) && (s.token == t.token) && (s.integrity_token == t.integrity_token));
}
inline bool operator ==(const quic_client_test_max::forged_quic_packet_vn &s, const quic_client_test_max::forged_quic_packet_vn &t){
    return ((s.ptype == t.ptype) && (s.pversion == t.pversion) && (s.dst_cid == t.dst_cid) && (s.src_cid == t.src_cid) && (s.supported_version == t.supported_version));
}
inline bool operator ==(const quic_client_test_max::replayed_quic_packet_0rtt &s, const quic_client_test_max::replayed_quic_packet_0rtt &t){
    return ((s.ptype == t.ptype) && (s.pversion == t.pversion) && (s.dst_cid == t.dst_cid) && (s.src_cid == t.src_cid) && (s.seq_num == t.seq_num) && (s.payload == t.payload));
}
inline bool operator ==(const quic_client_test_max::prot__header_info &s, const quic_client_test_max::prot__header_info &t){
...
inline bool operator ==(const quic_client_test_max::clients__client &s, const quic_client_test_max::clients__client &t){
    return ((s.ep == t.ep) && (s.tls_id == t.tls_id) && (s.enc_level == t.enc_level));
}
inline bool operator ==(const quic_client_test_max::servers__server &s, const quic_client_test_max::servers__server &t){
    return ((s.ep == t.ep) && (s.tls_id == t.tls_id) && (s.enc_level == t.enc_level));
}
