...
```
    var icid2 : initial_source_connection_id; #TODO update v29
    icid2.scid := 0;
    tp.transport_parameters := tp.transport_parameters.append(icid2);
}
...
chris TODO
```
    require is_transport_parameter_error | ~handshake_done_send;
}
```
